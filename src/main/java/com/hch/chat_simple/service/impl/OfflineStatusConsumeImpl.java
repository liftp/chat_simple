...
/**
 * 好友下线通知消费：收到 composition 消息后，推送给目标用户的 ws channel
 */
@Slf4j
@Service
public class OfflineStatusConsumeImpl implements ICompositionConsumeService {
